package com.epam.droneMarket.controller.filter;
...
public class LanguageFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (sessionLanguage == null) {
            requestContext.addSessionAttribute(ATTRIBUTE, UKR);
    ...
    private String removeLanguageParameter(HttpServletRequest request) {
        ...
        StringBuilder requestString = new StringBuilder(request.getContextPath() + "/drone-market?");
