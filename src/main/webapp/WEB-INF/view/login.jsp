...
<html>
<head>
    <title>Log In | Drone-market</title>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-6 my-sm-3">
            ...
            <c:if test="${sessionScope.user == null}">
                ...
                <form action="${pageContext.request.contextPath}/drone-market?command=checkLogin" method="post">
                    <div class="mb-3">
                ...
                <p class="text-muted"><fmt:message bundle="${loc}" key="language.noAccount"/> <a
                        href="/drone-market?command=logUp"><fmt:message bundle="${loc}" key="language.logUp"/></a></p>
