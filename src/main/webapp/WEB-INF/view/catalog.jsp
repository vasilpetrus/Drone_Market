...
<head>
    <title>Catalog | Drone-market</title>
</head>
                ...
                <div class="card-header">
                    <h5><c:out value="${product.name}"/>
                        ...
                        <c:if test="${sessionScope.role.name == 'admin'}">
                            <a href="${pageContext.request.contextPath}/drone-market?command=editProduct&productId=${product.id}">
                        ...
                        <div class="col-md-8">
                            ...
                            <c:if test="${sessionScope.user != null}">
                                <c:if test="${product.status == true}">
                                    ...
                                    <form action=${pageContext.request.contextPath}/drone-market?command=addToBasket
                                          method="post">
