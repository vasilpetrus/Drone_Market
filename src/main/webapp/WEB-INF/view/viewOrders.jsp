...
<head>
    <title>View orders | Drone-market</title>
</head>
<body>
...
<c:if test="${sessionScope.role.name == 'admin'}">
    <form action=${pageContext.request.contextPath}/drone-market method="post">
        <div class="p-3">
            <div class="row justify-content-center">
                <table class="table table-hover">
                    ...
                    <c:forEach var="userOrder" items="${userOrders}">
                        <tr>
                            ...
                            <td>
                                <button onclick="location.href = '${pageContext.request.contextPath}/drone-market?command=completeUserOrder&userOrderId=${userOrder.id}'"
                            ...
                            <td>
                                <button onclick="location.href = '${pageContext.request.contextPath}/drone-market?command=deleteUserOrder&userOrderId=${userOrder.id}'"
