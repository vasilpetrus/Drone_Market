...
<html>
<head>
    <title>Log Up | Drone-market</title>
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-6 my-sm-3">
            ...
            <form action="${pageContext.request.contextPath}/drone-market?command=registration" method="post">
                <div class="row mb-3">
            ...
            <p class="text-muted"><fmt:message bundle="${loc}" key="language.haveAccount"/><a
                    href="${pageContext.request.contextPath}/drone-market?command=logIn"> <fmt:message
                    bundle="${loc}" key="language.logIn"/></a></p>
            <a href="/drone-market?command=main"><fmt:message bundle="${loc}" key="language.home"/></a>
        </div>
        </c:if>
