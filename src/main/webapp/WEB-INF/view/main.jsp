...
<div class="container">
    ...
    <div class="row justify-content-center">
        <img src="static/images/drone-market.jpg" class="img-fluid" width="500" height="200">
    </div>
        ...
        <table class="table">
            <tr class="text-center">
                <td width="15%">
                    ...
                    <h5>
                        <fmt:message bundle="${loc}" key="language.freeDeliveryAllOverUkraine"/>
                    </h5>
                </td>
                <td width="15%">
                    <h4 class="text-primary">
                ...
                <td width="15%">
                    ...
                    <h5>
                        <fmt:message bundle="${loc}" key="language.partnership"/>
                    </h5>
                </td>
                <td width="15%">
                    <h4 class="text-primary">
